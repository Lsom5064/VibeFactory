...
class BuildMonitorService : Service() {
    ...
    private fun createNotificationChannels() {
        BuildNotificationController.createChannels(this, includeMonitorChannel = true)
    }
    ...
    private fun showTerminalNotification(taskId: String, response: StatusResponse, statusKey: String) {
        val notificationType = when (statusKey) {
            ...
            else -> TerminalBuildNotification.ATTENTION
        }
    ...
    private fun buildForegroundNotification(): Notification {
        ...
        val pendingIntent = PendingIntent.getActivity(
            ...
            Intent(this, MainActivity::class.java).apply {
                ...
                if (taskId.isNotBlank()) putExtra(MainActivity.EXTRA_SELECTED_TASK_ID, taskId)
            },
            PendingIntent.FLAG_UPDATE_CURRENT or PendingIntent.FLAG_IMMUTABLE
        )
        return NotificationCompat.Builder(this, BuildNotificationController.MONITOR_CHANNEL_ID)
